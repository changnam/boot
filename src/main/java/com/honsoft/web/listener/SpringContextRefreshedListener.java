...
public class SpringContextRefreshedListener implements ApplicationListener<ContextRefreshedEvent> {
	...
	private HashSet<String> beansSet = new HashSet<>();
	 ...
	 public void onApplicationEvent(ContextRefreshedEvent event) {
		logger.debug("===================> Handling context re-freshed event. ");
		...
		for (String beanName : beanNames) {
			logger.debug(cnt++ + " , " + beanName + " , " + context.getBean(beanName).getClass().toString());
		}
		logger.debug("====================");
		...
		for (String bean : allBeans) {
			if (!beansSet.contains(bean))
				...
				logger.debug(cnt++ + " , " + bean + " , " + context.getBean(bean).getClass().toString());
		}
	        
		logger.debug("====================== Handling context re-freshed event Ended. ====================== ");
	}
