	...
	public void setApplicationContext(ApplicationContext context) throws BeansException {
		...
		for (String bean : allBeans) {
			...
			if (!beansSet.contains(bean)) {
				if (beanObj instanceof Ordered) {
					logger.debug(cnt++ + " , <== manual ==> " + bean + " , " + beanObj.getClass().getTypeName() + " , " + beanObj.getClass().toString() + " , "
							+ ((Ordered) beanObj).getOrder());
				} else {
					logger.debug(cnt++ + " , <== manual ==> " + bean + " , " + beanObj.getClass().getTypeName() + " , " + beanObj.getClass().toString());
				}
				...
				if (beanObj instanceof Ordered) {
					logger.debug(cnt++ + " , " + bean + " , " + beanObj.getClass().getTypeName() + " , " + beanObj.getClass().toString() + " , "
							+ ((Ordered) beanObj).getOrder());
				} else {
					logger.debug(cnt++ + " , " + bean + " , " + beanObj.getClass().getTypeName() + " , " + beanObj.getClass().toString());
				}
